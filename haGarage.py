...
#    resources.addRes(HAControl("bathroomLight", thing, type="dimmer", group="Lights", label="Bathroom light"))
    bedroomLight = HAControl("bedroomLight", HARestInterface("bedroomLight", service ="192.168.1.126:7378", cache=False, event=stateChangeEvent), "/resources/bedroomLight/state", type="dimmer", group="Lights", label="Bedroom light")
...
#    resources.addRes(HASensor("testSwitch", gpio1, 7, type="light", group="Lights", label="Test input"))
    resources.addRes(HAScene("outsideLights", [frontLights,
                                               backLights,
