...
if __name__ == "__main__":
    ...
    schedule.addTask(HATask("shadesUpJunJul", HASchedTime(hour=[18], minute=[45], month=[Jun, Jul]), resources["allShades"], 0, enabled=True))
    schedule.addTask(HATask("shadesUpMayAug", HASchedTime(hour=[18], minute=[30], month=[May, Aug]), resources["allShades"], 0, enabled=True))
    schedule.addTask(HATask("shadesUpAprSep", HASchedTime(hour=[18], minute=[15], month=[Apr, Sep]), resources["allShades"], 0, enabled=True))
