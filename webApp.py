...
def solar():
    ...
    with resources.lock:
        return templates.get_template("solar.html").render(script="",
                            ...
                            inverterTemp=resources.getRes("inverters.stats.Temp"),
                            roofTemp=resources.getRes("optimizers.stats.Temp"),
                            currentVoltage=resources.getRes("inverters.stats.Pac"),
                            currentLoad=resources.getRes("currentLoad"),
                            currentPower=resources.getRes("inverters.stats.Pac"),
                            todaysEnergy=resources.getRes("inverters.stats.Eday"),
                            lifetimeEnergy=resources.getRes("inverters.stats.Etot"),
