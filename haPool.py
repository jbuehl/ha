...
#    dayLight = HASensor("daylight", timeInterface, "daylight")
    ...
    schedule.addTask(HATask("Sunday spa on", HASchedTime(year=[2016], month=[5], day=[15], hour=[16], minute=[0]), resources["spa"], 1))
    schedule.addTask(HATask("Sunday spa off", HASchedTime(year=[2016], month=[5], day=[15], hour=[18], minute=[0]), resources["spa"], 0))
