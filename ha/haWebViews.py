...
#         "tempF": HAView({}, "%d °", tempFormat),
         ...
         "poolValve": HAView({0:"Pool", 1:"Spa", 4:"Moving"}, "%s", None, {0:"Pool", 1:"Spa"}),
         "valveMode": HAView({0:"Pool", 1:"Spa", 2:"Drain", 3:"Fill", 4:"Moving"}, "%s", None, OrderedDict([(0,"Pool"), (1,"Spa"), (2,"Drain"), (3,"Fill")])),
