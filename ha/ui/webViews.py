...
#         "tempF": View({}, "%d °", tempFormat),
         ...
         "poolValve": View({0:"Pool", 1:"Spa", 2:"Off", 4:"Moving"}, "%s", None, OrderedDict([(0,"Pool"), (1,"Spa"), (2,"Off")])),
         "valveMode": View({0:"Pool", 1:"Spa", 2:"Drain", 3:"Fill", 4:"Clean"}, "%s", None, OrderedDict([(0,"Pool"), (1,"Spa"), (2,"Drain"), (3,"Fill"), (4,"Clean")])),
