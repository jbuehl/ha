...
#         "tempF": HAView({}, "%d °", tempFormat),
         ...
         "humidity": HAView({}, "%d %%"),
         "server": HAView({0:"Down", 1:"Up"}, "%s"),
         "nightLight": HAView({0:"Off", 1:"On", 2:"Sleep"}, "%s", None, {0:"Off", 1:"On", 2:"Sleep"}),
         "dimmer": HAView({0:"Off", 25:"25", 50:"50", 75:"75", 100:"100"}, "%s", None, {0:"Off", 25:"25", 50:"50", 75:"75", 100:"100"}),
